...
public class HomeForm extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        // Stat Cards
        javax.swing.JPanel pnlCard1 = createStatCard("📚 SÁCH QUÁ HẠN", new java.awt.Color(231, 76, 60));
        lblOverdueCount = new javax.swing.JLabel("0");
        
        javax.swing.JPanel pnlCard2 = createStatCard("⚠️ SẮP HẾT HẠN", new java.awt.Color(241, 196, 15));
        ...
        tblOverdue.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] { "Mã Thẻ", "Tên Độc Giả", "SĐT", "Email", "Tên Sách", "Hạn Trả", "Quá Hạn (ngày)" }
        ) {
        ...
        btnCallOverdue = new javax.swing.JButton("📞 Liên hệ độc giả");
        ...
        tabbedPane.addTab("🔴 Sách Quá Hạn", pnlOverdue);
        ...
        tblDueSoon.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] { "Mã Thẻ", "Tên Độc Giả", "SĐT", "Email", "Tên Sách", "Hạn Trả", "Còn (ngày)" }
        ) {
            boolean[] canEdit = new boolean [] { false, false, false, false, false, false, false };
            public boolean isCellEditable(int rowIndex, int columnIndex) {
                return canEdit [columnIndex];
        ...
        btnRemindDueSoon = new javax.swing.JButton("📧 Nhắc nhở độc giả");
        ...
        tabbedPane.addTab("⚠️ Sắp Hết Hạn (3 ngày)", pnlDueSoon);
        ...
        tblUnpaidPenalty.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] { "Mã Thẻ", "Tên Độc Giả", "SĐT", "Lý Do", "Số Tiền", "Ngày Phạt" }
        ) {
        ...
        tabbedPane.addTab("💰 Phạt Chưa Đóng", pnlUnpaid);
        ...
        lblWelcome.setText("👋 Chào mừng đến với Hệ Thống Quản Lý Thư Viện");
        
        lblDateTime.setFont(new java.awt.Font("Segoe UI", 0, 14));
        lblDateTime.setForeground(new java.awt.Color(127, 140, 141));
        lblDateTime.setText("📅 " + new java.text.SimpleDateFormat("EEEE, dd/MM/yyyy HH:mm:ss").format(new java.util.Date()));
